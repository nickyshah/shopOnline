...
export default async function EditCouponPage(props: Props) {
		...
		<div className="min-h-screen">
			<div className="relative">
				<div className="mb-6">
					...
					<h1 className="text-4xl font-bold text-gray-900 dark:text-white mb-2">Edit Coupon</h1>
					<p className="text-gray-600 dark:text-gray-400">Update coupon settings and conditions</p>
				</div>
